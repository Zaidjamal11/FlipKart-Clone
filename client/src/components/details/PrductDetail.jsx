       ...
       <Typography>{product.title.longTitle}</Typography>
            ...
            <Typography style={{ marginTop: 5, color: '#878787', fontSize: 14 }}>
              ...
              <Box component="span"><img src={fassured} alt="fassured" style={{ width: 77, marginLeft: 20}} /> </Box>
               ...
               <SmallText>
               <Typography><StyledBadge />Get extra 20% off upto ₹50 0n 1 item(s) T&C </Typography>
               <Typography><StyledBadge />Get extra 13% off (pice inclusive of discount) T&C </Typography>
